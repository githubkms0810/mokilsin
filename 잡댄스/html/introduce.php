...
================================================== -->
	<div class="row">
		...
		<h2><span>
            <a href="#" style="color: #292b2c; font-weight: 400; font-size: 22px;">동요제 소개</a></span></h2>
                    
                    <div>
        <p style="text-align:right;"><a href="birth.php" style="color: #292b2c; font-weight: 400; font-size: 12px;">동요작가 목일신</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="introduce.php" style="color: #292b2c; font-weight: 400; font-size: 12px;">목일신 동요제</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color: #292b2c; font-weight: 400; font-size: 12px;">동요제 소개</a></p>
        </div>
...
<div>
<p class="txt_center"><img src="../images/_ART/content/MokIlsin2017_in01.jpg" alt=""></p>
<p class="txt_center"><img src="../images/_ART/content/MokIlsin2017_in02.jpg" alt=""> </p>
</div>
			<!-- End Post Content -->
<!-- Begin Tags -->
