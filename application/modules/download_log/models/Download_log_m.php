...
//의존성 ::
class Download_log_M extends Pagination_Model 
{
	...
	protected function _from()
	{
		...
		$this->db->join("file as f","{$this->as}.file_id = f.id","LEFT");
	}
	...
	CONSTRAINT `fkDownloadLog_user_id` FOREIGN KEY (`user_id`) REFERENCES user(`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE
	,
	CONSTRAINT `fkDownloadLog_file_id` FOREIGN KEY (`file_id`) REFERENCES file(`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE
	,
