    ...
    <form id="mokilsin-form" action="/applicationn/add" method="post" enctype="multipart/form-data" class="project_form floating-labels" style="margin-top:100px; margin-bottom:150px;">
        ...
        <fieldset>
            ...
            <div>
                ...
                <input required type="text" pattern="^([0-9]{3})-?([0-9]{3,4})-?([0-9]{4})$" name="가창지도자연락처" value="<?=DEBUG === false ? "":"01055555555"?>" style="width:33%; display:inline-block;" placeholder="지도교사 및 보호자 연락처">
