<table  class="tg"  border ="1">
  <tr style="background-color:#d9e1f2">
    <th class="tg-agg0"></th>
    <th class="tg-agg0">단평</th>
    <th class="tg-agg0">지역</th>
    <th class="tg-agg0">인원</th>
  ...
  <?php $i=0; foreach ( $rows as $key=>$row ): ?>
    <tr>
        ...
        <td style="text-align:center; font-size:20px; padding:5 20; " class="tg-yw4l"><?=$row->중창단명?></td>
        <td style="text-align:center; font-size:20px; padding:5 20; " class="tg-yw4l"><?=$row->지역?></td>
        <td style="text-align:center; font-size:20px; padding:5 20; " class="tg-yw4l"><?=$row->총인원?></td>
