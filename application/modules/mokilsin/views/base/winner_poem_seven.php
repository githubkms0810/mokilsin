    ...
    <div style="margin:0 auto;">
        <div class="mainheading" style="margin-top:100px;">
            ...
            <div class="section-title">
                <h2><span>
            <a href="#" style="color: #292b2c; font-weight: 400; font-size: 22px;">동시 대회 2017년 수상작</a></span></h2>

                <div>
                    <p style="text-align:right;"><a href="birth.php" style="color: #292b2c; font-weight: 400; font-size: 12px;">동요작가 목일신</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="introduce_poem" style="color: #292b2c; font-weight: 400; font-size: 12px;">목일신 동시 대회</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;<a href="winner_music_eight" style="color: #292b2c; font-weight: 400; font-size: 12px;">역대수상작</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color: #292b2c; font-weight: 400; font-size: 12px;">동시 대회 2017년 수상작</a></p>
                </div>
        ...
        <div id="container">
            ...
            <div class="tabMenu mt20">
                <ul>
                    <li class="on"><a href="winner_poem_seven">동시 대회 2017년 수상작</a></li>
