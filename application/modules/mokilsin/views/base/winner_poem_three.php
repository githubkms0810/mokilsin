                ...
                <table class="tableStyle01" summary="수상자 명단">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">학교명</th>
                            <th class="liNone" scope="col">작품명</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>양다은</td>
                            <td>금산초 6</td>
                            <td class="liNone">내이름은 좀수수치</td>
                        </tr>
                        <tr>
                            <td rowspan="2">금 상<br />(2)</td>
                            <td>최영도</td>
                            <td>회천초 3</td>
                            <td class="liNone">가정방문</td>
                        </tr>
                        <tr>
                            <td>전우진</td>
                            <td>동 초 5</td>
                            <td class="liNone">가족</td>
                        </tr>
                        <tr>
                            <td rowspan="2">은 상<br />(2)</td>
                            <td>노다정</td>
                            <td>백양초 2</td>
                            <td class="liNone">바다</td>
                        </tr>
                        <tr>
                            <td>양민재</td>
                            <td>도화초 5</td>
                            <td class="liNone">갯벌 발자국</td>
                        </tr>
                        <tr>
                            <td rowspan="2">동 상<br />(2)</td>
                            <td>김아영</td>
                            <td>포두초 3</td>
                            <td class="liNone">할머니 품</td>
                        </tr>
                        <tr>
                            <td>백기림</td>
                            <td>대서초 6</td>
                            <td class="liNone">목일신동요제(떨림)</td>
                        </tr>
                        <tr>
                            <td rowspan="12">장 려<br />(12)</td>
                            <td>김정민</td>
                            <td>동강초 3</td>
                            <td class="liNone">하늘</td>
                        </tr>
                        <tr>
                            <td>김교현</td>
                            <td>녹동초 2</td>
                            <td class="liNone">친구가 되었어요</td>
                        </tr>
                        <tr>
                            <td>고명준</td>
                            <td>동 초 3</td>
                            <td class="liNone">내친구 자전거</td>
                        </tr>
                        <tr>
                            <td>박지나</td>
                            <td>금산초 5</td>
                            <td class="liNone">우리 엄마</td>
                        </tr>
                        <tr>
                            <td>홍준영</td>
                            <td>백양초 4</td>
                            <td class="liNone">벼룩시장</td>
                        </tr>
                        <tr>
                            <td>류승준</td>
                            <td>영남초 4</td>
                            <td class="liNone">동물농장 비단구렁이</td>
                        </tr>
                        <tr>
                            <td>김민성</td>
                            <td>대서초 6</td>
                            <td class="liNone">죽는다는 건</td>
                        </tr>
                        <tr>
                            <td>김유빈</td>
                            <td>회천초 6</td>
                            <td class="liNone">시간</td>
                        </tr>
                        <tr>
                            <td>문선미</td>
                            <td>회천초 6</td>
                            <td class="liNone">우리 반</td>
                        </tr>
                        <tr>
                            <td>문인성</td>
                            <td>회천초 6</td>
                            <td class="liNone">허수아비</td>
                        </tr>
                        <tr>
                            <td>유진아</td>
                            <td>녹동초 5</td>
                            <td class="liNone">어린 나비의 꿈</td>
                        </tr>
                        <tr>
                            <td>변성진</td>
                            <td>회천초 5</td>
                            <td class="liNone">어머니</td>
                        </tr>
                    </tbody>
                </table>
