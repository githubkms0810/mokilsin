...
<![endif]-->
                ...
                <div class="detailView">
                    <div class="viewHead">
                        ...
                        <dl class="file">
                            ...
                            <dd><a href="/public/mokilsin/images/download/꾸미기_201205161107411.jpg" name="btnAttach" catno="8447" title="#1 꾸미기_201205161107411.jpg 파일다운로드" download>
				<img src="/public/mokilsin/images/common/disket.gif" alt="file" class="imgVmiddle" /> #1 꾸미기_201205161107411.jpg</a></dd>
                    ...
                    <div class="viewBody">
                        ...
                        <script type="text/javascript">
                            $(document).ready(function() {
                                $("[name=attachPhoto]").click(function() {
                                    //$(this).hide();

                                    if ($(this).next().length > 0) {
                                        $(this).next().show();
                                    } else {
                                        $("[name=attachPhoto]").first().show();
                                    }
                                });
                                /* if($("[name=attachPhoto] img").width() > 600){
                                	$("[name=attachPhoto] img").width(600);
                                } */
                            });

                        </script>

                        <div id="attachPhotoBox" class="attachpt">


                            <div name="attachPhoto" count="0" class="txt_center pb30">


                                <img src="/public/mokilsin/images/download/꾸미기_201205161107411.jpg" width="740" />
            ...
            <div class="after-post-tags" style="margin-bottom:150px;">
                <ul class="tags">
                    <li><a href="winner_music_three">목록으로</a></li>
                </ul>
            </div>
