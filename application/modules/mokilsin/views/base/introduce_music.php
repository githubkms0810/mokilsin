...
================================================== -->
	<div class="row">
        ...
        <p style="text-align:right;"><a href="birth" style="color: #292b2c; font-weight: 400; font-size: 12px;">동요작가 목일신</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="introduce" style="color: #292b2c; font-weight: 400; font-size: 12px;">목일신 동요제</a>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color: #292b2c; font-weight: 400; font-size: 12px;">동요제 소개</a></p>
        </div>
...
<div style="width:150px; height:40px; background-color:#ee5550; border-radius:5px; margin: 0 auto; margin-bottom:150px;">
   <a href="/applicationn/add?kind=동요" style="color:#fff; width:100%; height:100%; display:table; text-align:center;">
